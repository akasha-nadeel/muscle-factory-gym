...
// (we use @ts-ignore not @ts-expect-error because the file does exist after
// cf:build, and @ts-expect-error would itself trigger "unused directive"
// errors once the import resolves).
import openNextWorker from "../.open-next/worker.js";
// @ts-ignore: same — generated module
